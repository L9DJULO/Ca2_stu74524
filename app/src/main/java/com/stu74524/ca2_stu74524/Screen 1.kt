    ...
    Scaffold(
        ...
        content = { innerPadding ->
            Column(
                ...
                Image(
                    painter = painterResource(id = R.drawable.fightclub), // Replace R.drawable.image with your image.png
                ...
                Text(
                    fontSize = 14.sp,
                    text = "A depressed insomniac (Edward Norton) meets Tyler Durden (Brad Pitt), a strange soap salesman. They form an underground club, fighting disillusioned men. Their partnership falters when Marla (Helena Bonham Carter) catches Tyler's eye.",
                    color = Color.Black,
                    textAlign = TextAlign.Start,
                )
