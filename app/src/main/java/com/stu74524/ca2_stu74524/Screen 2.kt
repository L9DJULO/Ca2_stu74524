    ...
    Scaffold(
        ...
        content = { innerPadding ->
            Column(
                ...
                Image(
                    painter = painterResource(id = R.drawable.seven), // Replace R.drawable.image with your image.png
                ...
                Text(
                    fontSize = 14.sp,
                    text = "Detective Somerset (Morgan Freeman) and newcomer Mills (Brad Pitt) investigate murders tied to the seven deadly sins. Somerset befriends Mills' pregnant wife, Tracy (Gwyneth Paltrow), worried about raising a child in the crime-ridden city.",
                    color = Color.Black,
                    textAlign = TextAlign.Start,
                )
